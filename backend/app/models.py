...
class Photo(Base):
    ...
    # 双语说明
    caption_fr: Mapped[str] = mapped_column(String(500), default="")
    caption_cn: Mapped[str] = mapped_column(String(500), default="")
...
class NewsItem(Base):
    ...
    content_cn: Mapped[str] = mapped_column(Text, default="")
    content_en: Mapped[str] = mapped_column(Text, default="")

    # 图片
    image_path: Mapped[str] = mapped_column(String(500), default="")
    image_caption: Mapped[str] = mapped_column(String(300), default="")
